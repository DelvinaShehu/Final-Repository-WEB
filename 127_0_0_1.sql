...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2024 at 03:47 PM
...
-- Database: `clearvue`
--
CREATE DATABASE IF NOT EXISTS `clearvue` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `clearvue`;
...
-- Database: `g1db`
--
CREATE DATABASE IF NOT EXISTS `g1db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `g1db`;
...
(10, 'arbnora', 'adili', 'asd@gmail.com', 'admin', '112');
...
-- Database: `gr1`
--
CREATE DATABASE IF NOT EXISTS `gr1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gr1`;
...
('root', '2024-01-24 13:53:40', '{\"Console\\/Mode\":\"collapse\"}');
